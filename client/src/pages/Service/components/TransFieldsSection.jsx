              ...
              <Grid container spacing={2} alignItems='center'>
                ...
                <Grid item xs={12} md={3}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleTransFieldChange(index, 'fieldName', e.target.value)
                    }
                    size='small'
                  />
                </Grid>
                <Grid item xs={12} md={2}>
                  <FormControl fullWidth size='small'>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        handleTransFieldChange(index, 'dataType', e.target.value)
                      }
                      label='Kiểu dữ liệu'
                    >
                ...
                <Grid item xs={12} md={2}>
                  <FormControl fullWidth size='small'>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        handleTransFieldChange(index, 'isRequired', e.target.value)
                      }
                      label='Bắt buộc'
                    >
              ...
              <Grid container spacing={2} sx={{ mt: 1 }}>
                ...
                <Grid item xs={12} md={2}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleTransFieldChange(index, 'errorCode', e.target.value)
                    }
                    size='small'
                  />
                </Grid>
